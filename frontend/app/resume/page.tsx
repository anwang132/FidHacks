...
export default function ResumePage() {
  return (
    <div className="min-h-screen bg-[#faf5fa] text-slate-900">
      ...
      {/* Page hero */}
      <section className="border-b border-violet-200/50">
        <div className="max-w-6xl mx-auto px-6 py-16">
          <p className="text-xs text-violet-600 font-semibold uppercase tracking-widest mb-4">AI-Powered</p>
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            <div>
              <h1 className="text-5xl lg:text-6xl font-black leading-none mb-4">
                Resume<br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-500 to-orange-400">
                  Fit Grader
                </span>
              </h1>
            ...
            <div className="flex gap-6 shrink-0">
              {[
                ...
                <div key={s.label} className="text-center">
                  <p className="text-2xl font-black text-violet-600">{s.val}</p>
